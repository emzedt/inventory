<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 xl:px-16 xl:ml-64 space-y-6">
        ...
        <div class="mt-4" x-data="{ imageUrl: '/storage/noimage.png' }">
            <form enctype="multipart/form-data" method="POST" action="{{ route('product.store') }}" class="flex gap-8">
                @csrf
                <div class="w-1/2">
                ...
                <div class="w-1/2">
                    ...
                    <div>
                        ...
                        <x-text-input id="selling_price" class="block mt-1 w-full" type="text" name="selling_price"
                            :value="old('selling_price')" x-mask:dynamic="$money($input, ',')" />
                    ...
                    <div>
                        ...
                        <x-text-input id="purchase_price" class="block mt-1 w-full" type="text" name="purchase_price"
                            :value="old('purchase_price')" x-mask:dynamic="$money($input, ',')" />
